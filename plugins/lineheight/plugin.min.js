tinymce.PluginManager.add('lineheight', function(editor, url) {
    ...
    var lineheight_val = tinymce.getParam('lineheight_val', '1 1.5 1.6 1.75 1.8 2 3 4 5');
    console.log()
    tinymce.on('init', function() {
        tinymce.formatter.register({
            lineheight: {
    ...
    var doAct = function (value) {
        tinymce.formatter.apply('lineheight', { value: value });
        tinymce.fire('change', {});
    };

    tinymce.ui.registry.getAll().icons.lineheight || tinymce.ui.registry.addIcon('lineheight','<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M9.984 12.984v-1.969h12v1.969h-12zM9.984 18.984v-1.969h12v1.969h-12zM9.984 5.016h12v1.969h-12v-1.969zM6 6.984v10.031h2.484l-3.469 3.469-3.516-3.469h2.484v-10.031h-2.484l3.516-3.469 3.469 3.469h-2.484z"></path></svg>');
    
    tinymce.ui.registry.addMenuButton('lineheight', {
        icon: 'lineheight',
        tooltip: pluginName,
        fetch: function(callback) {
            var dom = tinymce.dom;
            var blocks = tinymce.selection.getSelectedBlocks();
            var lhv = 0;
